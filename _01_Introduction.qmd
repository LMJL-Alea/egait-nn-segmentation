...
[We did not find in the literature a method based on hip orientation data represented as unit quaternion time-series which is the particularity of the data type used in our work.]{.mark}
...
[Furthermore, most methods presented either segment strides during a walking session or detect events inside already segmented strides.]{.mark}
